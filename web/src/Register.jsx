    ...
    <div className="min-h-screen flex items-center justify-center bg-indigo-900 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Register to get started with IT342 Lab 1</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-6">
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="text"
                required
                className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 outline-none transition"
          ...
          <button
            type="submit"
            className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded-lg shadow-lg shadow-green-100 transition transform active:scale-95"
          >
            Register Now
          </button>
        </form>
